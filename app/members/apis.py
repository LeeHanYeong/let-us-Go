...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        responses={
            ...
            status.HTTP_400_BAD_REQUEST: APIResponse(description="실패", examples={}),
        },
    ),
)
...
@method_decorator(
    name="get",
    decorator=swagger_auto_schema(
        operation_summary="User Retrieve", operation_description="사용자 정보"
    ),
)
@method_decorator(
    name="patch",
...
@method_decorator(
    name="delete",
    decorator=swagger_auto_schema(
        operation_summary="User Delete", operation_description="사용자 삭제(탈퇴)",
    ),
)
    ...
    decorator=swagger_auto_schema(
        ...
        responses={
            status.HTTP_200_OK: APIResponse(
                description="", examples={"application/json": {"exists": True,}}
            ),
        },
    ),
)
